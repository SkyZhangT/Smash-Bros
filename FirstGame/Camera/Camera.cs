...
namespace Sprint0.Cameraa
{
    public class Camera
    {
        ...
        public Vector2 PositionWithLimit
        {
            get
            {
                return _position;
        ...
        public Matrix GetViewMatrix(Vector2 parallax,float scale)
        {
        ...
        public void LookAt(Vector2 position,float width,float height)
        {
           this.Position = (position-new Vector2(width/2f,height/2f));
            Console.WriteLine(Position);
        }

        public void LookAtWithLimit(Vector2 position)
        {
            PositionWithLimit = position - new Vector2(_viewport.Width / 2.0f, _viewport.Height / 2.0f);
        }

        public void Move(Vector2 displacement/*=default(Vector2)*/, bool respectRotation /*= false*/)
        {
            if (respectRotation)
            {
