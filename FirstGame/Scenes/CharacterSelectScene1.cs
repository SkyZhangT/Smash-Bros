...
{
    public class CharacterSelectScene1:IScene
    {
        ...
        public CharacterSelectScene1(Game1 game)
        {
            Game = game;
        }
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(Font, "Press 1 to select Mario, 2 to select Luigi for player1", new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 200, 80), Color.White, 0, Vector2.Zero, .5f, SpriteEffects.None, 0);
